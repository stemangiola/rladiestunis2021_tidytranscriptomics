...
bibliography: "`r file.path(system.file(package='rladiestunis2021tidytranscriptomics', 'vignettes'), 'tidytranscriptomics.bib')`"
vignette: >
...
Background information and setup instructions for this workshop can be found [here](https://stemangiola.github.io/rladiestunis2021_tidytranscriptomics/articles/background.html). 
...
# Aggregate
pbmc_bulk = 
  rladiestunis2021tidytranscriptomics::pbmc %>% 
...
# Contributing
If you want to suggest improvements for this workshop or ask questions, you can do so as described [here](https://github.com/stemangiola/rladiestunis2021_tidytranscriptomics/blob/master/CONTRIBUTING.md).
